...
cwb = pd.DataFrame({'observe_time':observe_time, 'DAY':DAY, 'HOUR':HOUR, 'CITY':CITY, 'TOWN':TOWN, 'locationName':locationName, 
                    'CITY_SN':CITY_SN, 'TOWN_SN':TOWN_SN, 'stationId':stationId, 'lat':lat, 'lon':lon, 'lat_wgs84':lat_wgs84, 
                    'lon_wgs84':lon_wgs84, 'ELEV':ELEV, 'WDIR':WDIR, 'WDSD':WDSD, 'TEMP':TEMP, 'HUMD':HUMD, 'PRES':PRES,
                    'SUN':SUN, 'H_24R':H_24R, 'H_FX':H_FX, 'H_XD':H_XD, 'H_FXT':H_FXT, 'D_TX':D_TX, 'D_TXT':D_TXT, 'D_TN':D_TN, 
                    'D_TNT':D_TNT, 'access_time':access_time})
